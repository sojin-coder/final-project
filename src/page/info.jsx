...
// ប្រើ react-icons សម្រាប់ Social Media
import {
  Mail,
  Phone,
  MapPin,
    ...
    <div className="min-h-screen font-sans antialiased mt-[-40px]">
      ...
      >
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <p className="text-gray-200 text-lg md:text-2xl italic font-light mb-10 leading-relaxed">
            "From bean to cup - A journey of passion, quality, and community
            since 2020."
          </p>
          <button className="px-10 py-4 bg-amber-700 text-white rounded-full font-bold text-lg hover:bg-amber-800 transition-all transform hover:scale-105 shadow-2xl">
            Explore Menu
          </button>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-left">
            ...
            <button className="mt-10 px-10 py-4 border-2 border-[#A65D39] text-[#A65D39] rounded-full font-bold hover:bg-[#A65D39] hover:text-white transition-all duration-300">
              Meet Our Team
            </button>
          </div>
      ...
      <section className="py-24 bg-[#FAF9F6]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className=" w-[500px] mx-auto mb-10 bg-white p-12 rounded-[3rem] border border-gray-100 shadow-[0_20px_50px_rgba(0,0,0,0.05)] hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 group">
            {/* Profile Image */}
